  ...
  resources: {
    ...
    Product: {
      ...
      fields: {
        ...
        status: {
          type: "text",
          description: "Trạng thái (ACTIVE, INACTIVE, DRAFT)",
        },
    ...
    ProductVariant: {
      ...
      fields: {
        ...
        variant_name: {
          type: "text",
          description: "Tên biến thể (VD: 8GB/256GB Đen)",
        },
        color: { type: "text", description: "Màu sắc" },
        capacity: {
          type: "text",
          description: "Dung lượng (VD: 256GB, 512GB)",
        },
        price: { type: "number", description: "Giá bán thực tế (VNĐ)" },
        compare_at_price: {
          type: "number",
          description: "Giá so sánh / giá gốc (VNĐ)",
        },
    ...
    Category: {
      ...
      fields: {
        ...
        parent_id: {
          type: "uuid",
          description: "Mã danh mục cha (null = gốc)",
        },
    ...
    Coupon: {
      ...
      fields: {
        ...
        discount_type: {
          type: "text",
          description: "Loại giảm: PERCENTAGE hoặc FIXED_AMOUNT",
        },
        discount_value: {
          type: "number",
        ...
        min_order_value: {
          type: "number",
          description: "Đơn hàng tối thiểu để áp dụng",
        },
        max_discount_amount: {
          type: "number",
        ...
        status: {
          type: "text",
          description: "Trạng thái (ACTIVE, EXPIRED, PAUSED)",
        },
      },
      defaultSelect: [
        "code",
    ...
    FlashSale: {
      ...
      fields: {
        ...
        status: {
          type: "text",
          description: "Trạng thái: SCHEDULED, ACTIVE, ENDED",
        },
      },
    ...
    FeedbackStat: {
      ...
      fields: {
        ...
        last_review_at: {
          type: "timestamp",
          description: "Thời gian đánh giá gần nhất",
        },
      },
      defaultSelect: ["product_id", "avg_rating", "review_count"],
    },

    // IÁ TỐI THIỂU VARIANT (VIEW)
    MinVariant: {
      ...
      fields: {
        ...
        min_price: {
          type: "number",
          description: "Giá rẻ nhất trong các biến thể",
        },
        max_price: { type: "number", description: "Giá đắt nhất" },
        total_stock: {
          type: "number",
          description: "Tổng tồn kho tất cả biến thể",
        },
      },
